...
| prowlarr.targetRevision | string | `"1.42.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| radarr.targetRevision | string | `"1.17.0"` | [radarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/radarr) |
...
| readarr.targetRevision | string | `"1.14.1"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
...
| sonarr.targetRevision | string | `"1.10.2"` | [sonarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/sonarr) |
