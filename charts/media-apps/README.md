...
![Version: 0.6.18](https://img.shields.io/badge/Version-0.6.18-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.6.18](https://img.shields.io/badge/AppVersion-0.6.18-informational?style=flat-square)
...
| prowlarr.targetRevision | string | `"1.31.2"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| radarr.targetRevision | string | `"1.8.2"` | [radarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/radarr) |
...
| readarr.targetRevision | string | `"1.7.2"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
...
| sonarr.targetRevision | string | `"1.5.2"` | [sonarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/sonarr) |
