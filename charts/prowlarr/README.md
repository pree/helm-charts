...
![Version: 1.30.0](https://img.shields.io/badge/Version-1.30.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.13.2.4251](https://img.shields.io/badge/AppVersion-1.13.2.4251-informational?style=flat-square)
...
| metrics.exporter.image.tag | string | `"v1.6.1"` | image tag |
