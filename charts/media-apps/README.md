...
| prowlarr.targetRevision | string | `"1.41.1"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| radarr.targetRevision | string | `"1.15.1"` | [radarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/radarr) |
...
| readarr.targetRevision | string | `"1.13.1"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
...
| sonarr.targetRevision | string | `"1.10.1"` | [sonarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/sonarr) |
