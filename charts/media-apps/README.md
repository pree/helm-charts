...
| prowlarr.targetRevision | string | `"1.26.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| readarr.targetRevision | string | `"1.4.0"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
