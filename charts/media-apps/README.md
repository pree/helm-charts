...
![Version: 0.8.7](https://img.shields.io/badge/Version-0.8.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.8.7](https://img.shields.io/badge/AppVersion-0.8.7-informational?style=flat-square)
...
| clusterplex.targetRevision | string | `"1.1.10"` | [clusterplex Helm chart](https://github.com/pabloromeo/clusterplex/tree/master/charts/clusterplex) |
...
| jellyfin.targetRevision | string | `"3.2.0"` | [jellyfin Helm chart](https://github.com/jellyfin/jellyfin-helm/tree/master/charts/jellyfin) |
...
| overseerr.targetRevision | string | `"1.2.0"` | [overseerr Helm Chart](https://github.com/pree/helm-charts/tree/master/charts/overseerr) |
...
| prowlarr.targetRevision | string | `"1.54.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| radarr.targetRevision | string | `"1.29.0"` | [radarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/radarr) |
...
| readarr.targetRevision | string | `"1.17.1"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
...
| sonarr.targetRevision | string | `"1.16.0"` | [sonarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/sonarr) |
