...
![Version: 0.3.22](https://img.shields.io/badge/Version-0.3.22-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3.22](https://img.shields.io/badge/AppVersion-0.3.22-informational?style=flat-square)
...
| prowlarr.targetRevision | string | `"1.5.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| radarr.targetRevision | string | `"1.0.8"` | [radarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/radarr) |
...
| sonarr.targetRevision | string | `"1.1.1"` | [sonarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/sonarr) |
