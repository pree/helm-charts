...
| jellyfin.targetRevision | string | `"2.5.0"` | [jellyfin Helm chart](https://github.com/jellyfin/jellyfin-helm/tree/master/charts/jellyfin) |
...
| prowlarr.targetRevision | string | `"1.47.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| sonarr.targetRevision | string | `"1.11.0"` | [sonarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/sonarr) |
