...
| prowlarr.targetRevision | string | `"1.32.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| readarr.targetRevision | string | `"1.8.0"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
