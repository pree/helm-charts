...
![Version: 0.3.33](https://img.shields.io/badge/Version-0.3.33-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3.33](https://img.shields.io/badge/AppVersion-0.3.33-informational?style=flat-square)
...
| prowlarr.targetRevision | string | `"1.10.1"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
