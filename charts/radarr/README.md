...
![Version: 1.16.0](https://img.shields.io/badge/Version-1.16.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.22.3.9889](https://img.shields.io/badge/AppVersion-5.22.3.9889-informational?style=flat-square)
...
| metrics.exporter.image.tag | string | `"v2.1.0"` | image tag |
