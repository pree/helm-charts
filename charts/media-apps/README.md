...
| prowlarr.targetRevision | string | `"1.25.0"` | [prowlarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/prowlarr) |
...
| readarr.targetRevision | string | `"1.3.0"` | [readarr Helm chart](https://github.com/pree/helm-charts/tree/master/charts/readarr) |
